...
class LSTMEncoder(nn.Module):
    ...
    """
    def __init__(self, embedding_dim, hidden_dim, vocab_size, encoder_dropout=0, use_elmo=False):
    ...
    def lstm_forward(self, x, x_len, lstm, elmo_x=None, hidden=None):
    ...
    def forward(self, a, a_len, elmo_a=None):
        # Sentence LSTM A
        a_out, a_hidden = self.lstm_forward(a, a_len, self.a_lstm)
